    ...
    <Fragment>
      <Grid>
        ...
        <Grid.Column width={4}>
          ...
          {files.length > 0 && <PhotoUploadCropper setImage={setImage} imagePreview={files[0].preview} />}
        </Grid.Column>
        <Grid.Column width={1} />
        <Grid.Column width={4}>
          ...
          <Fragment>
               ...
               <Button.Group widths={2}>
                   <Button positive icon='check' loading={loading} onClick={()=> {
                       uploadingPhoto(image!)
                   }} />
                   <Button basic icon='close' disabled={loading} onClick={()=> {
                       setFiles([])
                   }} />
               </Button.Group>
          </Fragment>
